...
clear
echo -e "Created By \e[N33R47"
echo "----------------------------" | lolcat
echo -e "\e[1;92m "
echo "   ⊢□■□■□■□■□■□■□■□■□■□■□■□■□■□■□■□■□■□■□■□■□■□■□■□■□■□■□■□■■□■□■□■□■□■□■□■□■⊣"
echo -e "\e[1;92m"
echo "       _                      _______                      _ "
echo "    _nnnnn._              .adOOOOOOOOOba.              _,nnnnn_ "
echo "   dP   ~iiii            dOOOOOOOOOOOOOOOb            iiii~   Yb "
echo "   V      ~ rr          dOOOOOOOOOOOOOOOOOb          rr ~      V "
echo "             aa.       dOOOOOOOOOOOOOOOOOOOb       ,aa "
echo "              jjj._   |OOOOOOOOOOOOOOOOOOOOO|   _,jjj  "
